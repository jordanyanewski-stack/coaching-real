...
const curriculum = [
  { day: "Модул 1",  title: "Защо онлайн пространството не ти работи сега",   outcome: "Ще знаеш кои 3 грешки правиш в момента" },
  { day: "Модул 2",  title: "Как да говориш за работата си с увереност",      outcome: "Ще спреш да се извиняваш за цената и работата си" },
  { day: "Модул 3",  title: "Защо хаосът те коства клиенти",                  outcome: "Ще знаеш точно кое действие движи бизнеса ти" },
  { day: "Модул 4",  title: "Кой е твоят идеален клиент — в дълбочина",       outcome: "Профил толкова конкретен, че следващият пост ще пише сам себе си" },
  { day: "Модул 5",  title: "Как да монетизираш експертизата си с онлайн курс", outcome: "Идеята от главата на хартия, оценена, готова" },
  { day: "Модул 6",  title: "Как да се откроиш без да се сравняваш",          outcome: "Ще знаеш какво те прави различна и как да го кажеш" },
  { day: "Модул 7",  title: "Как да спреш да продаваш времето си",            outcome: "Модел при който доходът не зависи от броя часове" },
  { day: "Модул 8",  title: "Как да създадеш оферта, която се продава",       outcome: "Оферта позиционирана, оценена, готова за публикуване" },
  { day: "Модул 9",  title: "AI стратегии за намиране на клиенти",            outcome: "Спестяваш часове маркетинг всяка седмица" },
  { day: "Модул 10", title: "Как да поддържаш клиентопоток без бърнаут",      outcome: "Малки стъпки, водещи до предвидим доход" },
  { day: "Модул 11", title: "Вътрешните блокажи, които спират клиентите",     outcome: 'Страхът от „продажба“ спира да взима решения вместо теб' },
  { day: "Модул 12", title: "Твоят план за следващите 90 дни",                outcome: "Не вдъхновение. Конкретен документ, готов за изпълнение утре" },
];

const valueStack = [
  { label: "12 видео модула на запис",             tag: "€197" },
  { label: "Достъп по всяко време, завинаги",     tag: "включено" },
  { label: "AI prompt библиотека за бизнеса",     tag: "включено" },
  { label: "KickSTART система за работа",         tag: "включено" },
  { label: "Затворена общност за подкрепа",       tag: "включено" },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Всеки модул е около 90 минути. Гледаш го в удобно за теб време, без ограничение. Плюс кратка задача след всеки модул.",
  },
  {
  ...
  {
    q: "За колко време имам достъп?",
    a: "Завинаги. Веднъж закупен, курсът остава в профила ти без ограничение. Гледай, повтори, приложи.",
  },
];
    ...
    >
      <div className="reveal relative max-w-3xl mx-auto">
        ...
        >
          ...
          <span style={{ ...GRADIENT_TEXT }}>този курс е точно за теб.</span>
        </p>
  ...
  return (
    ...
    >
      <div className="reveal relative max-w-3xl mx-auto text-center">
        ...
        >
          Ако след първите 3 модула усетиш, че курсът не е за теб —{" "}
  ...
  return (
    ...
    >
      <div className="reveal relative max-w-3xl mx-auto text-center">
        ...
        >
          12 видео модула · Достъп веднага · Гледай в удобно за теб време
        </p>
