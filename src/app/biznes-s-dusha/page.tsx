...
export const metadata = {
  ...
  description:
    "За терапевти, бизнес коучове, коучинг специалисти и холистични специалисти, готови да превърнат практиката си в устойчив бизнес. 12 мастъркласове · 22 юли–2 август 2026 · от €37.",
};
...
const curriculum = [
  { day: "Ден 1",  date: "22 юли", title: "Защо хората с мисия се страхуват от структура",            outcome: "Ще разбереш откъде идва съпротивата — и защо е лъжа." },
  { day: "Ден 2",  date: "23 юли", title: "Защо терапевтите се съпротивляват на идеалния клиент",      outcome: "Идеалният клиент не е маркетинг трик. Той е основата." },
  { day: "Ден 3",  date: "24 юли", title: "„Не искам да се наглася“ — най-големият страх онлайн",       outcome: "Откъде идва и как да спреш да позволяваш страха да взима решения вместо теб." },
  { day: "Ден 4",  date: "25 юли", title: "Може ли маркетингът да бъде автентичен?",                   outcome: "Да — но само ако знаеш как. Ще разгледаме конкретни примери." },
  { day: "Ден 5",  date: "26 юли", title: "Защо имаш гледания, но нямаш продажби",                     outcome: "Разликата между аудитория и купувачи — с коя работиш ти." },
  { day: "Ден 6",  date: "27 юли", title: "Хора без граници = липса на позициониране",                  outcome: "Защо клиентите не те уважават — и как да промениш това веднага." },
  { day: "Ден 7",  date: "28 юли", title: "Защо терапевтите привличат хора, „само да питат нещо“",     outcome: "Границата между приятелски разговор и професионализъм в онлайн пространството." },
  { day: "Ден 8",  date: "29 юли", title: "Когато дарбата няма рамка, идва хаос",                       outcome: "Структурата не убива автентичността. Тя я освобождава." },
  { day: "Ден 9",  date: "30 юли", title: "Защо много добри специалисти се изтощават онлайн",           outcome: "Не е в работата. Не е в таланта. Ето откъде идва умората." },
  { day: "Ден 10", date: "31 юли", title: "Проблемът не е в съдържанието, а в посланието",              outcome: "Как да говориш за работата си така, че правилните хора да те намерят." },
  { day: "Ден 11", date: "1 август", title: "Какво всъщност означава „бизнес с душа“",                    outcome: "И как да изградиш такъв — без да се предаваш на себе си." },
  { day: "Ден 12", date: "2 август", title: "Твоят план за следващите 90 дни",                            outcome: "Не вдъхновение. Конкретен документ, готов за изпълнение утре." },
];
    ...
    >
      <div className="reveal relative max-w-5xl mx-auto">
        <div className="text-center mb-6">
          ...
          >
            Всяка вечер от 17:00 до 18:30 ч. в Zoom. 22 юли–2 август 2026. Записи включени. Задачи и обратна
    ...
    >
      <div className="reveal relative max-w-3xl mx-auto text-center">
        ...
        <p className="mt-5" style={{ fontSize: "17px", color: T.textSecondary, lineHeight: 1.55, fontWeight: 600 }}>
          12 дни. 12 мастъркласове. Всяка вечер от 17:00 до 18:30 ч. в Zoom. Старт 22 юли 2026.
        </p>
