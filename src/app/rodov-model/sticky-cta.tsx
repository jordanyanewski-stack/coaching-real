...
export function RodovStickyCTA() {
  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          "linear-gradient(180deg, rgba(26,20,16,0) 0%, rgba(26,20,16,0.92) 30%, rgba(26,20,16,0.98) 100%)",
    ...
    >
      <a
        ...
        style={{
          ...
          boxShadow:
            "0 12px 32px rgba(139,105,20,0.45), 0 1px 2px rgba(0,0,0,0.1)",
          whiteSpace: "nowrap",
        }}
      >
        Включи се — €97
