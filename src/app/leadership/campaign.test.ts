...
describe("Magi August 2026 leadership campaign configuration", () => {
  it("uses €36 through the 24 August start date and switches to €97 at midnight in Sofia", () => {
    ...
    expect(new Date(REGULAR_PRICE_START).toISOString()).toBe("2026-08-24T21:00:00.000Z");
