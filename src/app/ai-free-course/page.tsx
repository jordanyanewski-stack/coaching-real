...
const weeks = [
  ...
  },
  {
    ...
    items: [
      ...
      "Бранд аудит — как те виждат другите",
...
const youGetCards: { icon: IconName; title: string; body: string }[] = [
  { icon: "compass", title: "Ясност накъде вървиш", body: "Попълнен Strengths Finder и Ценностна матрица — знаеш точно кои са силните ти страни и накъде те водят в ерата на AI." },
  ...
  { icon: "star", title: "Личен бранд и LinkedIn", body: "Попълнен бранд аудит и оптимизиран LinkedIn профил — вече се виждаш и позиционираш правилно." },
...
const materials: { icon: IconName; week: string; title: string; items: string[] }[] = [
  ...
  },
  {
    icon: "star",
    week: "Седмица 3",
    title: "Личен бранд + LinkedIn оптимизация",
    items: [
      "Бранд аудит (4 ключови въпроса)",
  ...
  },
  {
    ...
    items: [
      ...
      "Обещание към себе си + следващ шаг",
    ],
  },
];
...
const forYouYes = [
  ...
  "Нямаш технически бекграунд — и не ти трябва такъв",
...
const faqs = [
  ...
  },
  {
    ...
    a: "Всяка седмица получаваш попълваеми работни листи: Strengths Finder, Ценностна матрица, Job Market Analysis, Skills Gap Analysis, Бранд аудит, LinkedIn чек-лист, 90-дневен план и система за проследяване на целите. Реални инструменти, не само информация.",
  },
  {
    q: "Нужно ли е техническо образование?",
    a: "Абсолютно не. Курсът е създаден за хора без технически бекграунд. Фокусът е върху стратегия, умения за мислене и позициониране — не върху кодиране.",
  },
  {
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            4-седмична онлайн програма с практически работни материали, ясна
    ...
    >
      <div className="reveal max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          >
            4 седмици. <span style={{ fontFamily: SERIF, fontStyle: "italic", fontWeight: 500, color: "#a5b8d8" }}>4 трансформации.</span>
          </h2>
          <p
            style={{
              fontSize: "16px",
