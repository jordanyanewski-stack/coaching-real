...
export function ZhivaStickyCTA() {
  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          "linear-gradient(180deg, rgba(15,28,20,0) 0%, rgba(15,28,20,0.92) 30%, rgba(15,28,20,0.98) 100%)",
    ...
    >
      <a
        ...
        style={{
          ...
          gap: "8px",
          padding: "16px 20px",
          background: "linear-gradient(135deg, #c4385a 0%, #9e2a48 100%)",
          color: "#ffffff",
          fontSize: "15px",
          fontWeight: 700,
          borderRadius: "6px",
          ...
          boxShadow:
            "0 12px 32px rgba(196,56,90,0.45), 0 1px 2px rgba(0,0,0,0.1)",
          whiteSpace: "nowrap",
        }}
      >
        Включи се — €97
