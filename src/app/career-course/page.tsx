...
export const metadata = {
  ...
  description:
    "Шест онлайн мастъркласа на живо за собственици на бизнес — 24–29 август, 18:00–19:00 ч., с Маги Пенчева. Лидерство, делегиране, екип и AI стратегия за €36.",
};
...
const faqs = [
  {
    ...
    a: "Еднократна такса €36 за всичките шест мастъркласа на живо, записите и работните материали. Без абонамент и без скрити такси.",
  },
  {
    ...
    >
      ...
      >
        ...
        <aside style={{ position: "relative" }}>
          ...
          <EnrollForm
            product="magi-leadership-live"
            variant="dark"
            submitLabel="Запази мястото си за €36 →"
          />
    ...
    >
      ...
      <div className="reveal relative max-w-3xl mx-auto">
        ...
        >
          ...
          материали, записи и личен 90-дневен план. €36 общо.
        </p>
        <div
          id="enroll"
