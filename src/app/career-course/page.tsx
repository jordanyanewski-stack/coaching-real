...
const meetingDates = [
  { num: "Модул 01", date: "Седмица 1", day: "Самооткриване" },
  { num: "Модул 02", date: "Седмица 2", day: "Анализ" },
  { num: "Модул 03", date: "Седмица 3", day: "Позициониране" },
  { num: "Модул 04", date: "Седмица 4", day: "Действие" },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Курсът е при поискване — всички записи са достъпни веднага след записване. Всеки модул е около 2 часа.",
  },
  {
      ...
      >
        ...
        <div>
          ...
          >
            ...
            />
            Курс · При поискване · Пълни записи
          </div>
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        >
          4 модула <em style={{ color: FD.accent }}>· при поискване</em>
        </h3>
        <p
          style={{
            textAlign: "center",
        ...
        >
          Гледай в удобно за теб време · Записи
        </p>
